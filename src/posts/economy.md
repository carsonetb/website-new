---
title: 'Managed Municipalism: A Modern Economic Solution'
date: 'on July 22, 2026'
description: 'A modern economic system based on Municipalism and Communism.'
---
...
Western European states are the gold standard of Liberalism, and their quality of life (specifically their health) seems to be better than Americans in most metrics[^1]. This is because, generally, liberal policy is slightly better suited to the working class than the late stage Capitalism in America.

But Liberalism is better than right-wing Capitalism in the same way that spinach tastes better than a pile of shit. Instead of abolishing the Capitalist upper-class which exploits the lower-class by design, it simply aims to emplace laws which protect the lower-class from the worst of the exploitation (for example by providing free healthcare, public services, and other protections for workers).

Liberalism is a great stepping stone, but if we seek to create a society free of exploitation, we need to look further.

## Authoritarianism

First we must exclude all right-wing ideologies. These are ones which are hierarchical, and within those hierarchies the different layers have competing interests.

So the goal of our society will instead be to increase equality[^2], especially for the working class. This is the left-wing ideal.
...
The idea that the state can algorithmically route logistics seems very promising, so we should try to apply it to municipalist model. When the central government was managing the needs of every person (a person is the fundamental unit of the model), we saw that there were problems of surveilance and complexity.

Instead, the municipalities are the fundamental units. A municipality both imports and exports goods. At the state level, an algorithm takes the requirements of all of the municipalities and the exports of all the municipalities, and routes goods accordingly. If there is a shortage of a certain resource, the algorithm requests that municipalities which have the ability to produce that resource increase their production.

This system seems capable, but naturally an unhandled yet common case arises. What if none of the municipalities want to increase their production? It is much easier to simply continue as normal than to either innovate to make production easier, or to work longer and harder.

To provide an incentive, we make a rule for the algorithm. The value of the resources which a municipality requests must be roughly equal to the value that it exports. In other words, _to each according to its production_. Now, all we have to do is figure out a system of value.
...
This model works well for goods, but what about services? These include the police, fire fighters, healthcare, public transportation, roads, housing, energy, water, and the list goes on.

The way we think about services versus products should be different. Products go _to each according to its output_, but services must go _to each according to its needs._ Therefore, a certain percentage of the national supply will be allocated to developing national services.

## Incentive

One of the classical critiques of Communism is the incentive structure. In Capitalism, people are incentivised by the fear of death—if they don't work they won't make money, and if they don't have money they won't be able to buy food, and if they don't have food they will die. This system of incentives is inhumane.

In modern times there seems to be an opinion that humans are fundamentally driven by greed. It is interesting that this opinion exists, because the psychology, behavioral science, and neuroscience all seem to disagree[^5]. Rather—once basic needs are met—humans desire mastery of skills they enjoy which can be used to improve society.

It seems that because humans are subject to cultural shifts, in a Capitalist world their motive can be shifted to greed. Luckily, because an attitude of societal improvement seems to be the default of human nature, it should be much easier to educate this attitude than its counterpart.
...
I believe this system could work very well, although it is in its early stages and has some rougher edges which need to be smoothed out. I would especially love to hear criticism from Liberals, but also traditional Capitalists, so please email me at me@carsonetb.com with your feedback!

[^1]:
    Michaud, Pierre-Carl, Dana Goldman, Darius Lakdawalla, Adam Gailey, and Yuhui Zheng. "Differences in health between Americans and Western Europeans: effects on longevity and public finance." _Social science & medicine_ 73, no. 2 (2011): 254-263.(viewable at [this link](https://pmc.ncbi.nlm.nih.gov/articles/PMC3383030/)).
    
    This is somewhat outdated but the claim is not super relevant, so I digress.

[^2]: There are multiple ways to do this. One is by lowering the quality of life of most people, which is generally a bad option, and indeed not an option at all for our society. The other is by raising the quality of life of most people, which works to an extent but eventually it will become clear that people need to do work so that goods and services can be available.
...
[^5]:
    ...
    Henrich, Joseph, Robert Boyd, Samuel Bowles, Colin Camerer, Ernst Fehr, Herbert Gintis, and Richard McElreath. "In search of homo economicus: behavioral experiments in 15 small-scale societies." _American economic review_ 91, no. 2 (2001): 73-78. (Viewable at [this link](https://pricetheory.uchicago.edu/levitt/Papers/HeinrichBoyd2001.pdf)).
